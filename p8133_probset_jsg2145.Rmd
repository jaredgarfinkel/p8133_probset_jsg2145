...
There is `r round(1 - pbinom(3, 32, .05), 5)` probability of this outcome under the null.

Under the alternative, there is `r round(1 - pbinom(3, 32, .2), 4)` probability for this outcome.

The number of participants required for a fixed design trial is 2 more than for the adaptive model. 
